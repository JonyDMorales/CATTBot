...
var workspace_id = 'b7168aab-1ed1-4031-aaad-a900b759dacf';
var conversation = new Watson({
    username: '3e27dc10-cec7-469c-9bfe-cb3b94e81d75',
    password: 'EgBUSp6v3Ixo',
...
function sendUserName(senderID, userName, messagePostback){
    ...
    function sendToConversation(){
        var that = this;
        conversation.message({input: { text: that.messageText }, context: that.context, 
            workspace_id: workspace_id}, function processResponse(err, response) {
                if (err) {
